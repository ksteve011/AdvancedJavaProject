...
public class main{
	...
	public static void login() {
	    ...
	    javax.swing.JLabel l1,l2;  
	    l1=new javax.swing.JLabel("Username");  //Create label Username
	    l1.setBounds(30,15, 100,30); //x axis, y axis, width, height 
	     
	    l2=new javax.swing.JLabel("Password");  //Create label Password
	...
	try {
	        ...
	        Connection con = DriverManager.getConnection("jdbc:mysql://localhost/mysql?user=Student&password=Student");
